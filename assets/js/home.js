    ...
    contactForm.addEventListener("submit", (event) => {
      ...
      if (!isValid) {
        formMessage.textContent =
          "Please complete all required fields and check that your email is correct.";
        formMessage.style.color = "#F15A24";
        return;
      }

      formMessage.textContent = "Thank you! Your request has been prepared.";
      formMessage.style.color = "#D9D9D9";
